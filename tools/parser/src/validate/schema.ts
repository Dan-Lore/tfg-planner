...
export function buildReportFromPack(
  ...
  return {
    ...
    stats: {
      ...
      recipeIoLocalized: extra.recipeIoLocalized,
      recipeIoTagsLocalized: extra.recipeIoTagsLocalized,
      recipeIoItemsLocalized: extra.recipeIoItemsLocalized,
      recipeIoFluidsLocalized: extra.recipeIoFluidsLocalized,
      recipeIoTotal: extra.recipeIoTotal,
      recipeIoTagsTotal: extra.recipeIoTagsTotal,
    },
    warnings,
