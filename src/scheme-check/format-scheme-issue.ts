...
const SUMMARY_KEYS: Record<SchemeIssueCode, string> = {
  ...
  cycle_no_seed: 'editor.schemeCheck.issues.cycle_no_seed',
...
const REASON_KEYS: Record<SchemeIssueCode, string> = {
  ...
  cycle_no_seed: 'editor.schemeCheck.issues.cycle_no_seed_reason',
...
const DETAIL_KEYS: Partial<Record<SchemeIssueCode, string>> = {
  ...
  cycle_no_seed: 'editor.schemeCheck.issues.cycle_no_seed_detail',
