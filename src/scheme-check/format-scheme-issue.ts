...
function baseParams(
  ...
  return {
    ...
    netRate: ctx.netRate ?? '',
    sccIndex: ctx.sccIndex ?? '',
    nodeIds: ctx.nodeIds ?? '',
    balanceRatio: ctx.balanceRatio ?? '',
    source,
    target,
...
const SUMMARY_KEYS: Record<SchemeIssueCode, string> = {
  ...
  disconnected_output: 'editor.schemeCheck.issues.disconnected_output',
  orphan_start_buffer: 'editor.schemeCheck.issues.orphan_start_buffer',
  target_on_buffer: 'editor.schemeCheck.issues.target_on_buffer',
  target_not_output: 'editor.schemeCheck.issues.target_not_output',
  target_missing_node: 'editor.schemeCheck.issues.target_missing_node',
  cycle_product_deficit: 'editor.schemeCheck.issues.cycle_product_deficit',
  cycle_product_surplus: 'editor.schemeCheck.issues.cycle_product_surplus',
  cycle_not_running: 'editor.schemeCheck.issues.cycle_not_running',
  catalyst_imbalance: 'editor.schemeCheck.issues.catalyst_imbalance',
...
const REASON_KEYS: Record<SchemeIssueCode, string> = {
  ...
  disconnected_output: 'editor.schemeCheck.issues.disconnected_output_reason',
  orphan_start_buffer: 'editor.schemeCheck.issues.orphan_start_buffer_reason',
  target_on_buffer: 'editor.schemeCheck.issues.target_on_buffer_reason',
  target_not_output: 'editor.schemeCheck.issues.target_not_output_reason',
  target_missing_node: 'editor.schemeCheck.issues.target_missing_node_reason',
  cycle_product_deficit: 'editor.schemeCheck.issues.cycle_product_deficit_reason',
  cycle_product_surplus: 'editor.schemeCheck.issues.cycle_product_surplus_reason',
  cycle_not_running: 'editor.schemeCheck.issues.cycle_not_running_reason',
  catalyst_imbalance: 'editor.schemeCheck.issues.catalyst_imbalance_reason',
...
const DETAIL_KEYS: Partial<Record<SchemeIssueCode, string>> = {
  ...
  disconnected_output: 'editor.schemeCheck.issues.disconnected_output_detail',
  orphan_start_buffer: 'editor.schemeCheck.issues.orphan_start_buffer_detail',
  target_on_buffer: 'editor.schemeCheck.issues.target_on_buffer_detail',
  target_not_output: 'editor.schemeCheck.issues.target_not_output_detail',
  target_missing_node: 'editor.schemeCheck.issues.target_missing_node_detail',
  cycle_product_deficit: 'editor.schemeCheck.issues.cycle_product_deficit_detail',
  cycle_product_surplus: 'editor.schemeCheck.issues.cycle_product_surplus_detail',
  cycle_not_running: 'editor.schemeCheck.issues.cycle_not_running_detail',
  catalyst_imbalance: 'editor.schemeCheck.issues.catalyst_imbalance_detail',
