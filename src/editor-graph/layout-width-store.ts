import type { BuildMachineNodeLayoutWidthsInput } from '@/editor-graph/machine-layout-width';
import {
  computeCustomMachineLayoutWidth,
  computeGroupLayoutWidth,
} from '@/editor-graph/machine-layout-width';
import { machineNodeLayoutSigFragment } from '@/editor-graph/layout-port-stubs';
import { MACHINE_NODE_MIN_WIDTH } from '@/editor-graph/node-layout-constants';
